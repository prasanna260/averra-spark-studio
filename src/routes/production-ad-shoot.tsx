...
export const Route = createFileRoute("/production-ad-shoot")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Studio-grade ad films, brand stories and product films from concept to final cut." },
...
function ProductionAdShoot() {
  return (
    <ServicePageLayout
      ...
      bullets={[
        { title: "Pre-Production", body: "Concept, scripting, storyboards, casting and location scouting — every shot mapped before day one." },
        { title: "On-Set Direction", body: "Cinema-grade lighting, sound and direction. Lean crews, premium output." },
        { title: "Post & Edit", body: "Color, sound design, motion graphics and VFX delivered in every aspect ratio you need." },
        { title: "Distribution Cuts", body: "TVCs, YouTube longs, 30s spots, 6s bumpers and reel cutdowns — one shoot, every channel." },
      ]}
    />
  );
}
